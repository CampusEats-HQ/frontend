      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="px-6 py-4 flex items-center justify-between border-b border-gray-200">
          <div className="flex items-center gap-6">
            ...
            <nav className="hidden lg:flex gap-4">
              ...
              <Link to="/admin/finance" className="flex items-center gap-2 px-3 py-2 rounded-lg" style={{ backgroundColor: '#DBEAFE', color: '#6366F1' }}>
                <DollarSign size={18} />
        ...
        <div className="px-6 py-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="rounded-lg p-4 md:p-5 border" style={{ borderColor: '#E0E0E0' }}>
            ...
            <div className="rounded-lg p-4 md:p-5 border-2" style={{ borderColor: '#F59E0B' }}>
              <p className="text-xs mb-2" style={{ color: '#6B7280' }}>
                Pending Payouts
              </p>
              <p className="text-2xl md:text-3xl font-bold break-words" style={{ color: '#F59E0B' }}>
            ...
            <div className="rounded-lg p-4 md:p-5 border" style={{ borderColor: '#E0E0E0' }}>
              ...
              <p className="text-2xl md:text-3xl font-bold break-words" style={{ color: '#10B981' }}>
            ...
            <div className="mb-8">
              ...
              {filteredVendorPayouts.length === 0 ? (
                <div className="text-center py-12">
                  <p style={{ color: '#6B7280' }}>All vendors settled!</p>
                </div>
              ) : (
                <div className="space-y-3">
                  {filteredVendorPayouts.map((vendor) => (
                    <div
                      key={vendor.id}
                      className="rounded-lg p-4 md:p-5 border flex flex-col md:flex-row md:items-center justify-between gap-4"
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 md:gap-4">
                        <div className="text-left md:text-right flex-1">
                          ...
                          <p className="text-xl md:text-2xl font-bold truncate" style={{ color: '#F59E0B' }}>
                        ...
                        {vendor.status === 'pending' && (
                          <button
                            ...
                            className="px-3 md:px-4 py-2 rounded-lg font-semibold text-xs md:text-sm whitespace-nowrap"
          ...
          {activeTab === 'riders' && (
            <div className="mb-8">
              ...
              {filteredRiderPayouts.length === 0 ? (
                <div className="text-center py-12">
                  <p style={{ color: '#6B7280' }}>All riders settled!</p>
                </div>
              ) : (
                <div className="space-y-3">
          ...
          <div>
            ...
            {filteredSettlementHistory.length === 0 ? (
              <div className="text-center py-12">
                <p style={{ color: '#6B7280' }}>No settlements in this period</p>
              </div>
            ) : (
              <div className="space-y-3">
                ...
                <div
                  key={settlement.id}
                  className="rounded-lg p-4 border flex flex-col md:flex-row md:items-center justify-between gap-3"
                ...
                >
                  ...
                  <div className="text-left md:text-right flex items-center md:flex-col md:items-end gap-2">
                    <p className="text-lg md:text-xl font-bold" style={{ color: '#10B981' }}>
